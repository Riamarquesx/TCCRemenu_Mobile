      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.listaReceitas}>
          ...
          <View style={styles.card}>
            <Image source={require("../assets/sopa.jpg")} style={styles.cardImg} />
...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 26, fontWeight: "600", color: "#44a67f" },
  subtitulo: { color: "#666", fontSize: 13, marginTop: 4, lineHeight: 18 },
  ...
  btnFiltrosTexto: { fontSize: 14, fontWeight: "500" },
  listaReceitas: { gap: 18 },
  card: {
    backgroundColor: "#fff",
    borderRadius: 12,
    overflow: "hidden",
  ...
  favoritoIcon: { fontSize: 20 },
  cardBody: { padding: 14 },
  cardTitulo: { fontSize: 16, fontWeight: "600", marginBottom: 4 },
  cardDescricao: { fontSize: 13, color: "#555", marginBottom: 10 },
  cardInfo: {
    flexDirection: "row",
